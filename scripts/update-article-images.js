...
function generateResponsiveImageHTML(imagePath, imageName, altText) {
    ...
    const inlineStyles = 'width: 100%; height: auto; max-height: 500px; display: block; object-fit: contain; object-position: center; border-radius: 8px; background: rgba(255, 255, 255, 0.3) !important; padding: 8px;';
